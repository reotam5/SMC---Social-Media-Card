...
function Profile() {
    ...
    return (
        <>
            <div class="min-h-screen flex flex-col max-w-lg mx-auto border-r border-l border-gray-300 opacity-100 font-poppins px-4 bg-no-repeat bg-cover bg-center">
                <div class="flex flex-col items-center px-4 pt-12 justify-between">
                    <QRCodeTest
                        data={`${window.location.protocol}//${window.location.host}/?info=${qrData}`}
                    />
                    <div class="w-9/12 flex items-center justify-center pl-6">
                ...
                <div class="pt-12 px-4 w-full flex flex-col">
                    ...
                    <div class="flex w-full pt-2 space-x-2 flex-wrap">
                        {isEditing ? (
                            <TextField
                                value={tempText}
                ...
                <div class="pt-12 px-4 mb-4 w-full flex flex-col">
                    <div className="flex justify-between">
                        <p class="font-semibold text-gray-600">SNS</p>
                    </div>
...
function AddItem({ handleAdd }) {
    ...
    return (
        <div class="flex flex-row w-full pt-2 space-y-2 px-4 justify-between items-center">
